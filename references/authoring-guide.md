...
4. **형식** — 화면 라이브, PDF 내보내기, Xiaohongshu 사진 및 텍스트?
...
- For bilingual titles, stack lines: `<h1 class="h1">테마제목테마<br><span class="dim">English subtitle</span></h1>`.
...
- **Don't put presenter-only text on the slide.** Any descriptive text,
  내레이션 단서 또는 화자를 위한 설명(예: "이 페이지의 요점은...",
