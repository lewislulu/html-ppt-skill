...
| 16 | `paper-presentation` | 11 | Cream paper + serif fonts + blue academic accent, comparison tables, light code blocks with theme-aware syntax, framed figures with caption + callout per figure. Zero animations, squared corners. | 学术论文汇报, CS/工程论文分享, research talk |
